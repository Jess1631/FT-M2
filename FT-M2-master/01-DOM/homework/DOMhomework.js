...
ToDo.prototype.completeToDo = function () {
  this.complete = !this.complete; // para tachar y destachar un elemento de la lista podemos colocar en lugar de:
                                  // this.complete = true; --> this.complete = !this.complete;
                                  // de esta manera, si esta en true, pasará a false. y si esta en false, pasará a true
};
...
add.addEventListener('click', addToDo);   //document.getElementById('addButton').addEvenListener('click', addToDo);
